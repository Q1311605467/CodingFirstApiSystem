...
public class ContestController {
    ...
    public ResultJsonVO getContestInfo(@RequestParam("contestId") Integer contestId,
        ...
        ContestInfoPO contestInfoPO = contestInfoService.queryContestInfoByContestId(contestId);
    ...
    public ResultJsonVO getContestProblemList(@RequestParam("contestId") Integer contestId) {
        ResultJsonVO resultJsonVO = new ResultJsonVO();
        List<ContestProblemPO> contestProblemPOS = contestProblemService.queryContestProblemByContestId(contestId);
