...
public interface ChallengeBlockService {
     ...
     * @return
     */
    List<UserChallengeBlockVO> queryUserChallengeBlockByUsername(String username);
     ...
     * @return
     */
    ChallengeBlockVO queryChallengeBlockByBlockIdAndUsername(Integer blockId, String username);
     ...
     * @return
     */
    List<ChallengeBlockConditionVO> queryChallengeBlockConditionByBlockId(Integer blockId);
