...
public class UserProblemSolvedServiceImpl implements UserProblemSolvedService {
    ...
    @Override
    public UserProblemSolvedPO queryUserProblemSolvedCountByUsernameAndProblemId(String username, Integer problemId) {
        return userProblemSolvedMapper.queryUserProblemSolvedByUsernameAndProblemId(username, problemId);
    }
}
