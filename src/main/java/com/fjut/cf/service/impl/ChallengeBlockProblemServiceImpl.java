...
public class ChallengeBlockProblemServiceImpl implements ChallengeBlockProblemService {
    ...
    @Override
    public List<ChallengeBlockProblemVO> queryChallengeBlockProblemByBlockIdAscLimit(String username, Integer blockId, Integer startIndex, Integer pageSize) {
        List<ChallengeBlockProblemVO> challengeBlockProblemVOS = challengeBlockProblemMapper.queryChallengeBlockProblemByBlockIdAscLimit(blockId, startIndex, pageSize);
        List<UserProblemSolvedPO> userSolvedProblems = userProblemSolvedMapper.queryUserProblemSolvedByUsername(username);
